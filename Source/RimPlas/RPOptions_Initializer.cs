...
namespace RimPlas
{
	...
	internal static class RPOptions_Initializer
	{
		...
		{
			LongEventHandler.QueueLongEvent(new Action(RPOptions_Initializer.Setup), "LibraryStartup", false, null, true);
		}
		...
		public static void Setup()
		{
			...
			if (allDefs.Count > 0)
			{
				List<string> RPList = RPOptions_Initializer.RPResearchList();
