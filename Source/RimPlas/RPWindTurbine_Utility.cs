...
namespace RimPlas
{
	...
	{
		// Token: 0x060000AC RID: 172 RVA: 0x00006343 File Offset: 0x00004543
		internal static IEnumerable<IntVec3> CalculateWindCells(IntVec3 center, Rot4 rot, IntVec2 size)
		{
			...
			int num4;
			for (int z2 = rectA.minZ; z2 <= rectA.maxZ; z2 = num4 + 1)
			{
			...
			for (int z2 = rectB.minZ; z2 <= rectB.maxZ; z2 = num4 + 1)
			{
